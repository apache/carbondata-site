...
class Home extends Language {
  ...
  componentDidMount() {
    ...
    fetch('https://api.github.com/repos/apache/carbondata')
      .then(res => res.json())
      .then((data) => {
        this.setState({
          ...this.state,
  ...
  render() {
    ...
    const headerLogo = headerType === 'normal' ? '/img/logo_colorful.png' : '/img/logo.png';
    return (
      <div className="home-page">
        <section className="top-section">
          ...
          <div className="img_over"><img src="/img/banner_over.png" /></div>
          <Header
            currentKey="home"
            type={headerType}
            logo={headerLogo}
          ...
          <div className="vertical-middle">
            ...
            <div className="github-buttons">
              <a href="https://github.com/apache/carbondata" target="_blank" rel="noopener noreferrer">
                <div className="star">
              ...
              <a href="https://github.com/apache/carbondata/fork" target="_blank" rel="noopener noreferrer">
                <div className="fork">
