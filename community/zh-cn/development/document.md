...
良好的使用文档对任何类型的软件都是至关重要的。欢迎任何可以改进 CarbonData 文档的贡献。

### 获取文档项目

CarbonData 项目的文档维护在独立的 [git 仓库](https://github.com/apache/CarbonData-website)中。

首先你需要先将文档项目 fork 到自己的 github 仓库中，然后将 fork 的文档克隆到本地计算机中。

```
git clone https://github.com/<your-github-user-name>/CarbonData-website
```

### 文档环境

CarbonData 网站由 [docsite](https://github.com/chengshiwen/docsite-ext) 提供支持。
