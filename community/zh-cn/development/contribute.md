...
首先非常感谢大家选择和使用 CarbonData，非常欢迎大家加入 CarbonData 大家庭，融入开源世界！

我们鼓励任何形式的参与社区，最终成为 Committer 或 PPMC，如： 
* 将遇到的问题通过 github 上 [issue](https://github.com/apache/CarbonData/issues) 的形式反馈出来
* 回答别人遇到的 issue 问题
* 帮助完善文档
* 帮助项目增加测试用例
* 为代码添加注释
...
* 帮助推广 CarbonData，参与技术大会或者 meetup 的分享等
...
* 完成后，发送一个 Pull Request 到 CarbonData，提交过程具体请参考下面《[提交代码流程](submit-code.md)》。
