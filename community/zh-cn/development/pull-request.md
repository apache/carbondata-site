...
在 CarbonData 中配置 checkstyle 和 code-style 的方式：

1.checkstyle 和 code-style 配置文件

checkstyle: https://github.com/apache/CarbonData/blob/dev/style/checkstyle.xml

code-style: https://github.com/apache/CarbonData/blob/dev/style/intellij-java-code-style.xml
