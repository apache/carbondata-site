...
* 首先从远端仓库*https://github.com/apache/CarbonData.git* fork一份代码到自己的仓库中
...
*  添加远端仓库地址，命名为upstream
    ...
    ` git remote add upstream https://github.com/apache/CarbonData.git `
